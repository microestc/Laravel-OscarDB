...
class OscarGrammar extends BaseGrammar
{
    /**
    ...
    public function compileInsert(Builder $query, array $values)
    {
        ...
        // row inserts in Oscar. However, if there are multiples, we'll continue.
        $count = count($values);
        ...
        // Oscar requires us to build the multi-row insert as multiple inserts with
    ...
    {
        if (Config::get('oscardb::database.quoting') === true) {
