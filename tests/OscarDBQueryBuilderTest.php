...
class OscarDBQueryBuilderTest extends TestCase
{
    ...
    {
        $builder = $this->getOscarBuilderWithProcessor();
    ...
    public function testWhereDateOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testWhereDayOscar()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users')->whereDay('created_at', '=', 1);
    ...
    public function testOrWhereDayOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testWhereMonthOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testOrWhereMonthOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testWhereYearOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testOrWhereYearOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testWhereTimeOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testWhereTimeOperatorOptionalOscar()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users')->whereTime('created_at', '22:00');
        $this->assertSame('select * from "users" where TO_CHAR("created_at", \'HH24:MI:SS\') = ?', $builder->toSql());
    ...
    public function testWhereLikeOscar()
    {
        $builder = $this->getOscarBuilder();
    ...
    public function testUnions()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->union($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 2));
        ...
        $union = $this->getOscarBuilder()->select('a')->from('t4')->where('a', 11)->where('b', 2);
    ...
    public function testUnionAlls()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->unionAll($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 2));
    ...
    public function testMultipleUnions()
    {
        ...
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->union($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 2));
        $builder->union($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 3));
    ...
    public function testMultipleUnionAlls()
    {
        ...
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->unionAll($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 2));
        $builder->unionAll($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 3));
    ...
    public function testUnionWithJoin()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users');
        $builder->union($this->getOscarBuilder()->select('*')->from('dogs')->join('breeds', function ($join) {
    ...
    public function testOscarUnionOrderBys()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->union($this->getOscarBuilder()->select('*')->from('users')->where('id', '=', 2));
    ...
    public function testOscarUnionLimitsAndOffsets()
    {
        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('users');
        $builder->union($this->getOscarBuilder()->select('*')->from('dogs'));
    ...
    public function testUnionAggregate()
    {
        ...
        $builder->from('posts')->union($this->getOscarBuilder()->from('videos'))->count();
    }
    ...
    public function testOrderBys()
    {
        ...
        $builder->select('*')->from('posts')->where('public', 1)
            ->unionAll($this->getOscarBuilder()->select('*')->from('videos')->where('public', 1))
    ...
    public function testReorder()
    {
        ...
        $builder->union($this->getOscarBuilder()->select('*')->from('second'));
    ...
    public function testOrderBySubQueries()
    {
        ...
        $builder = $this->getOscarBuilder()->select('*')->from('users')->orderBy($subQuery);
        $this->assertSame("$expected asc", $builder->toSql());

        $builder = $this->getOscarBuilder()->select('*')->from('users')->orderBy($subQuery, 'desc');
        $this->assertSame("$expected desc", $builder->toSql());

        $builder = $this->getOscarBuilder()->select('*')->from('users')->orderByDesc($subQuery);
        $this->assertSame("$expected desc", $builder->toSql());

        $builder = $this->getOscarBuilder();
        $builder->select('*')->from('posts')->where('public', 1)
            ->unionAll($this->getOscarBuilder()->select('*')->from('videos')->where('public', 1))
            ->orderBy($this->getOscarBuilder()->selectRaw('field(category, ?, ?)', ['news', 'opinion']));
    ...
    {
        $builder = $this->getOscarBuilder();
        $builder->from('posts')->select('id')->union($this->getOscarBuilder()->from('videos')->select('id'));
    ...
    {
        $builder = $this->getOscarBuilder();
        $builder->selectRaw('(sale / "overall".sales) * 100 AS percent_of_total')->from('sales')->crossJoinSub($this->getOscarBuilder()->selectRaw('SUM(sale) AS sales')->from('sales'), 'overall');
    ...
    public function testJoinSub()
    {
        ...
        $builder = $this->getOscarBuilder();
        $eloquentBuilder = new EloquentBuilder($this->getOscarBuilder()->from('contacts'));
        $builder->from('users')->joinSub($eloquentBuilder, 'sub', 'users.id', '=', 'sub.id');
        $this->assertSame('select * from "users" inner join (select * from "contacts") as "sub" on "users"."id" = "sub"."id"', $builder->toSql());

        $builder = $this->getOscarBuilder();
        $sub1 = $this->getOscarBuilder()->from('contacts')->where('name', 'foo');
        $sub2 = $this->getOscarBuilder()->from('contacts')->where('name', 'bar');
        $builder->from('users')
    ...
    {
        $builder = $this->getOscarBuilder();
        $builder->from('users')->leftJoinSub($this->getOscarBuilder()->from('contacts'), 'sub', 'users.id', '=', 'sub.id');
    ...
    {
        $builder = $this->getOscarBuilder();
        $builder->from('users')->rightJoinSub($this->getOscarBuilder()->from('contacts'), 'sub', 'users.id', '=', 'sub.id');
    ...
    {
        $builder = $this->getOscarBuilder();
        $second = $this->getOscarBuilder()->select('*')->from('users')->orderByRaw('id = ?', 2);
        $third = $this->getOscarBuilder()->select('*')->from('users')->where('id', 3)->groupBy('id')->having('id', '!=', 4);
        $builder->groupBy('a')->having('a', '=', 1)->union($second)->union($third);
        $this->assertEquals([0 => 1, 1 => 2, 2 => 3, 3 => 4], $builder->getBindings());

        $builder = $this->getOscarBuilder()->select('*')->from('users')->where('email', '=', function ($q) {
    ...
    {
        $builder = m::mock(OscarQueryBuilder::class.'[where,exists,insert]', [
        ...
        $builder = m::mock(OscarQueryBuilder::class.'[where,exists,update]', [
            m::mock(ConnectionInterface::class),
            new Grammar,
            m::mock(Processor::class),
        ]);
    ...
    {
        $builder = m::spy(OscarQueryBuilder::class.'[where,exists,update]', [
            m::mock(ConnectionInterface::class),
            new Grammar,
            m::mock(Processor::class),
        ]);
    ...
    public function testDynamicWhere()
    {
        ...
        $builder = m::mock(OscarQueryBuilder::class)->makePartial();
    ...
    public function setupCacheTestQuery($cache, $driver)
    {
        ...
        $builder = $this->getMock(OscarQueryBuilder::class, ['getFresh'], [$connection, $grammar, $processor]);
    ...
    public function testMergeBuilders()
    {
        $builder = $this->getOscarBuilder();
        $builder->addBinding(['foo', 'bar']);
        $otherBuilder = $this->getOscarBuilder();
    ...
    public function testSubSelect()
    {
        ...
        $builder = $this->getOscarBuilder();
        $builder->from('one')->select(['foo', 'bar'])->where('key', '=', 'val');
        $subBuilder = $this->getOscarBuilder();
    ...
    {
        $builder = $this->getOscarBuilder(false);
        $builder->select('*')->from('users');
        $this->assertEquals('select * from users', $builder->toSql());
    ...
    public function testUnionNotUsingQuotes()
    {
        $builder = $this->getOscarBuilder(false);
        $builder->select('*')->from('users')->where('id', '=', 1);
        $builder->union($this->getOscarBuilder(false)->select('*')->from('users')->where('id', '=', 2));
        $this->assertEquals('(select * from users where id = ?) union (select * from users where id = ?)', $builder->toSql());
        $this->assertEquals([0 => 1, 1 => 2], $builder->getBindings());
    }
    ...
    protected function getOscarBuilder($quote = true)
    {
    ...
    {
        return m::mock(OscarQueryBuilder::class, [
            m::mock(ConnectionInterface::class),
            new Grammar,
            m::mock(Processor::class),
        ])->makePartial();
