...
class OscarDBSchemaGrammarTest extends TestCase
{
    ...
    {
        $grammar = new class extends OscarGrammar {};

        $this->expectException(LogicException::class);
        $this->expectExceptionMessage('This database driver does not support creating databases.');

        $grammar->compileCreateDatabase('foo', m::mock(OscarConnection::class));
    }    
    ...
    {
        return m::mock(OscarConnection::class);
    }
