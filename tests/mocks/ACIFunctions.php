...
namespace Microestc\OscarDB\ACI_PDO {
    // ACI specific
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_error")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_connect")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_pconnect")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_close")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_commit")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_rollback")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_parse")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\get_resource_type")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_bind_by_name")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_num_fields")) {
        function aci_num_fields($a = '')
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_free_statement")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_execute")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_fetch_assoc")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_fetch_row")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_fetch_array")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_fetch_all")) {
    ...
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_field_type")) {
        function aci_field_type($a, $b)
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_field_type_raw")) {
        function aci_field_type_raw($a, $b)
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_field_name")) {
        function aci_field_name($a, $b)
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_field_size")) {
        function aci_field_size($a, $b)
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_field_precision")) {
        function aci_field_precision($a, $b)
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_num_rows")) {
        function aci_num_rows($a)
        {
            return 1;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_client_version")) {
        function aci_client_version()
        {
            return 'Test Return';
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_free_descriptor")) {
        function aci_free_descriptor($a)
        {
            return $a;
        }
    }
    if (! function_exists("Microestc\OscarDB\ACI_PDO\aci_internal_debug")) {
